...
const renderRules = {
  ...
  text: (node, children, parent, styles) => {
    return <Text key={node.key} style={[styles.text, {
  ...
  strong: (node, children, parent, styles) => {
    return (
      <Text key={node.key} style={[styles.text, styles.strong]}>
        {children}
      </Text>
    );
  },
  ...
  s: (node, children, parent, styles) => {
    return (
      <Text key={node.key} style={[styles.text, styles.strikethrough]}>
        {children}
      </Text>
    );
  },
  ...
  link: (node, children, parent, styles) => {
    return (
      <Text key={node.key} style={[styles.text, styles.link]} onPress={() => openUrl(node.attributes.href)}>
        {children}
      </Text>
    );
  },
  ...
  em: (node, children, parent, styles) => {
    return (
      <Text key={node.key} style={[styles.text, styles.em]}>
        {children}
      </Text>
    );
  },
  ...
  code_inline: (node, children, parent, styles) => {
    return (
      <Text key={node.key} style={[styles.text, styles.codeInline]}>
        {node.content}
      </Text>
    );
  },
  code_block: (node, children, parent, styles) => {
    return (
      <Text key={node.key} style={[styles.text, styles.codeBlock]}>
        {node.content}
      </Text>
    );
  },
    ...
    if (hasParents(parent, 'bullet_list')) {
      return (
        <View key={node.key} style={styles.listUnorderedItem}>
          <Text style={[styles.text, styles.listUnorderedItemIcon]}>{'•'}</Text>
    ...
    if (hasParents(parent, 'ordered_list')) {
      return (
        <View key={node.key} style={styles.listOrderedItem}>
          <Text style={[styles.text, styles.listOrderedItemIcon]}>{node.index + 1}{node.markup}</Text>
          <View style={[styles.listItem]}>{children}</View>
        </View>
      );
    }
  ...
  // br
  softbreak: (node, children, parent, styles) => <Text key={node.key} style={[styles.text]}>{'\n'}</Text>,
